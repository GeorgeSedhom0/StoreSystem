            ...
            actualBills.forEach((bill) => {
              bill.products.forEach((product) => {
                if (product.name === selectedProd.name) {
                  ...
                  else if (bill.type === "buy") flow.buy += quantity;
                  else if (bill.type === "buy-return")
                    flow["buy-return"] += quantity;
                ...
                <Table>
                  <TableHead>
                    <TableRow>
                      ...
                      <TableCell align="center">شراء</TableCell>
                      <TableCell align="center">مرتجع شراء</TableCell>
